...
def mother_function_inputs_a():
    mother_function_inputs_a = {
        ...
        'logger_a_path'      : 'NILM_and_DRL_based_EMS/DESO/SIL_Simulations/SIL_Results/Actual/Real/logger.log',
        ...
        'Min_SOC'            : 0,
        'capture_rate'       : 900,
        'Folder_name'        : 'NILM_and_DRL_based_EMS/DESO/SIL_Simulations/SIL_Results/Actual/Real/',
        'Testing'            : False,
...
def Load_data_a(mother_function_inputs_a, logger_a):
    ...
    for i in range(res_dictionary_size):
        file_path = FILE_DIR_PATH / mother_function_inputs_a[
            'res_folder_path'] / f"{mother_function_inputs_a['res_file_name']}{i + 1}.json"
...
def mother_function_inputs_b():
    mother_function_inputs_b = {
        ...
        'logger_b_path'      : 'NILM_and_DRL_based_EMS/DESO/SIL_Simulations/SIL_Results/Optimized_Predicted/Real/logger.log',
        'Load_path'          : 'NILM_and_DRL_based_EMS/DESO/SIL_Simulations/Mother_function_inputs/Mother_function_inputs_data.csv',
        'PV_path'            : 'NILM_and_DRL_based_EMS/DESO/SIL_Simulations/Mother_function_inputs/Mother_function_inputs_data.csv',
        'Time_stamp'         : 'NILM_and_DRL_based_EMS/DESO/SIL_Simulations/Mother_function_inputs/Mother_function_inputs_data.csv',
        'model_path'         : 'docs/Typhoon/Faster/faster_Hybrid-inverter_VARTAPulseneo_Digital_twin_Real.tse',
        ...
        'Min_SOC'            : 0,
        'capture_rate'       : 900,
        'Folder_name'        : 'NILM_and_DRL_based_EMS/DESO/SIL_Simulations/SIL_Results/Optimized_Predicted/Real/',
        'Testing'            : False,
...
def Load_data_b(mother_function_inputs_b, logger_b):
    ...
    for i in range(res_dictionary_size):
        file_path = FILE_DIR_PATH / mother_function_inputs_b[
            'res_folder_path'] / f"{mother_function_inputs_b['res_file_name']}{i + 1}.json"
        with open(file_path, 'r') as file:
            res_dictionary[f'res_{i}'] = json.load(file)
