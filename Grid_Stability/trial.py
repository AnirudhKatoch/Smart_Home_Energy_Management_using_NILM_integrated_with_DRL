...
SCP_0_2 = '0.2MVA'
csv_path = f'Voltages_Results/Average_day/{SCP_0_2}/Actual/'
alle(csv_path)

SCP_1 = '1MVA'
csv_path = f'Voltages_Results/Average_day/{SCP_1}/Actual/'
alle(csv_path)

SCP_5 = '5MVA'
csv_path = f'Voltages_Results/Average_day/{SCP_5}/Actual/'
alle(csv_path)

df_Actual = pd.read_feather(FILE_DIR_PATH/f'Voltages_Results/Average_day/{SCP_0_2}/Actual/df_absolute.feather')
Line_Voltage_Actual_0_2 = df_Actual['Vrms_meas_kV_Grid']

df_Actual = pd.read_feather(FILE_DIR_PATH/f'Voltages_Results/Average_day/{SCP_1}/Actual/df_absolute.feather')
Line_Voltage_Actual_1 = df_Actual['Vrms_meas_kV_Grid']

df_Actual = pd.read_feather(FILE_DIR_PATH/f'Voltages_Results/Average_day/{SCP_5}/Actual/df_absolute.feather')
Line_Voltage_Actual_5 = df_Actual['Vrms_meas_kV_Grid']

Line_Voltage_Actual_0_2 = Line_Voltage_Actual_0_2.rolling(window=250, min_periods=1).mean()
Line_Voltage_Actual_1 = Line_Voltage_Actual_1.rolling(window=250, min_periods=1).mean()
Line_Voltage_Actual_5 = Line_Voltage_Actual_5.rolling(window=250, min_periods=1).mean()

fig1, ax1 = plt.subplots(figsize=(6.4,4.8))
df_Actual['Time_seconds'] = df_Actual.index/3600

ax1.plot(df_Actual['Time_seconds'], Line_Voltage_Actual_0_2 , label=f'0.2 MVA')
ax1.plot(df_Actual['Time_seconds'], Line_Voltage_Actual_1 , label=f'1 MVA')
ax1.plot(df_Actual['Time_seconds'], Line_Voltage_Actual_5 , label=f'5 MVA')
...
ax1.grid(True)
plt.tight_layout()
fig1.savefig(FILE_DIR_PATH / f'Voltages_Results/Graph.png')
