...
def mother_function_inputs_a():
    mother_function_inputs_a = {
        ...
        'model_path'         : 'docs/Typhoon/Faster/faster_Hybrid-inverter_VARTAPulseneo_Digital_twin_grid_stability_PV_constant_Load.tse',
...
def test_mother_a(setup_a, Test, mother_function_inputs_a, logger_a, Load_data_a):
    ...
    for i, _ in enumerate(Load_dataframe_value):
        ...
        hil.model_write('PV Power Input', PV_dataframe_value[i]*0.65)
