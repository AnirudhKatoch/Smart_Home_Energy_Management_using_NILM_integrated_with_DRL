...
def mother_function_inputs_a():
    mother_function_inputs_a = {
        ...
        'logger_a_path'      : 'Grid_Stability/Results/Actual/logger.log',
        'Load_path'          : 'Grid_Stability/Database/Load_input.csv',
        'PV_path'            : 'Grid_Stability/Database/Irradiance_data.csv',
        'model_path'         : 'docs/Typhoon/Faster/faster_Hybrid-inverter_VARTAPulseneo_Digital_twin_grid_stability.tse',
        'Initial_battery_SOC': 0,
        'Control_Mode'       : 1,
        'Max_SOC'            : 100,
        'Min_SOC'            : 0,
        'capture_rate'       : 900,
        'Folder_name'        : 'Grid_Stability/Results/Actual/',
        'Testing'            : False,
        'Column_Load'        : 'Load_actual_W',
        'Column_PV'          : 'Irradiance',
...
def test_mother_a(setup_a, Test, mother_function_inputs_a, logger_a, Load_data_a):
    ...
    cap.start_capture(duration=test_time,
                      ...
                      signals=['PV Power Plant (Generic) UI1.Available_Ppv_kW',
                               ...
                               'Three-phase Meter GRID.VAn_RMS'
                               ], absolute_time=True)
    ...
    for i, _ in enumerate(Load_dataframe_value):
        ...
        hil.model_write('PV Power Plant (Generic) UI1.Irradiance', PV_dataframe_value[i]*0.6)
...
def mother_function_inputs_b():
    mother_function_inputs_b = {
        ...
        'logger_b_path'      : 'Grid_Stability/Results/Optimized_Predicted/logger.log',
        'Load_path'          : 'Grid_Stability/Database/Load_input.csv',
        'PV_path'            : 'Grid_Stability/Database/Irradiance_data.csv',
        'model_path'         : 'docs/Typhoon/Faster/faster_Hybrid-inverter_VARTAPulseneo_Digital_twin_grid_stability.tse',
        'Initial_battery_SOC': 0,
        ...
        'Min_SOC'            : 0,
        'capture_rate'       : 900,
        'Folder_name'        : 'Grid_Stability/Results/Optimized_Predicted/',
        'Testing'            : False,
        'Column_Load'        : 'Optimized_predicted_W',
        'Column_PV'          : 'Irradiance',
        'Loop_step_time'     : 0.9800208333333332,
    }
