...
df.to_csv( FILE_DIR_PATH / f'NILM_efficiency/Databases/Load_Profile_actual.csv', sep=';' )
...
ax1.plot(df.index/60, df['Vaccum_Cleaner'],label = 'Vaccum_Cleaner')
...
ax1.set_title('Load for a 24 hour period')
plt.grid()
plt.legend()
fig1.savefig(FILE_DIR_PATH/f'NILM_efficiency/Figures/Load_profile_Actual.png')
#plt.show()
